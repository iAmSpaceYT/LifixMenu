...
namespace PLAYER
{
	static Player GET_PLAYER_PED(Player player) { return invoke<Player>(0x43A66C31C68491C0, player); } // 0x43A66C31C68491C0 0x6E31E993
	...
	static void SET_PLAYER_MODEL(Player player, Hash modelHash) { invoke<Void>(0x00A1CADD00108836, player, modelHash); } // 0x00A1CADD00108836 0x774A4C54
	static void CHANGE_PLAYER_PED(Player player, Ped ped, BOOL p, BOOL p3) { invoke<Void>(0x048189FAC643DEEE, player, ped, p, p3); } // 0x048189FAC643DEEE 0xBE515485
	...
	static void SET_POLICE_RADAR_BLIPS(Player test) { invoke<Void>(0x43286D561B72B8BF, test); } // 0x43286D561B72B8BF 0x8E114B10
	...
	static Player IS_PLAYER_FREE_FOR_AMBIENT_TASK(Vehicle player) { return invoke<Player>(0xDCCFD3F106C36AB4, player); } // 0xDCCFD3F106C36AB4 0x85C7E232
	...
	static Vehicle* GET_CAUSE_OF_MOST_RECENT_FORCE_CLEANUP() { return invoke<Vehicle*>(0x9A41CF4674A12272); } // 0x9A41CF4674A12272 0x39AA9FC8
	...
	static int GIVE_ACHIEVEMENT_TO_PLAYER(int achievement) { return invoke<int>(0xBEC7076D64130195, achievement); } // 0xBEC7076D64130195 0x822BC992
	...
	static void SET_SWIM_MULTIPLIER_FOR_PLAYER(Ped player, float multiplier) { invoke<Void>(0xA91C6F0FF7D16A13, player, multiplier); } // 0xA91C6F0FF7D16A13 0xB986FF47
	...
	static void SPECIAL_ABILITY_CHARGE_MEDIUM(Player player, Vehicle p1, Vehicle p2) { invoke<Void>(0xF113E3AA9BC54613, player, p1, p2); } // 0xF113E3AA9BC54613 0xAB55D8F3
	...
	static Vehicle IS_SPECIAL_ABILITY_ACTIVE(Ped player) { return invoke<Vehicle>(0x3E5F7FC85D854E15, player); } // 0x3E5F7FC85D854E15 0x1B17E334
	...
	static void START_PLAYER_TELEPORT(Player player, float x, float y, float z, float heading, Any keepVehicle, Any keepVelocity, Any p7) { invoke<Void>(0xAD15F075A4DA0FDE, player, x, y, z, heading, keepVehicle, keepVelocity, p7); } // 0xAD15F075A4DA0FDE 0xC552E06C
	...
	static void SET_PLAYER_WEAPON_DAMAGE_MODIFIER(Player player, Pickup* damageAmount) { invoke<Void>(0xCE07B9F7817AADA3, player, damageAmount); } // 0xCE07B9F7817AADA3 0xB02C2F39
	...
	static void SIMULATE_PLAYER_INPUT_GAIT(Player control, float amount, int gaitType, float speed, BOOL p4, BOOL p5) { invoke<Void>(0x477D5D63E63ECA5D, control, amount, gaitType, speed, p4, p5); } // 0x477D5D63E63ECA5D 0x0D77CC34
	...
	static BOOL _0x690A61A6D13583F6(Ped p0) { return invoke<BOOL>(0x690A61A6D13583F6, p0); } // 0x690A61A6D13583F6 0x1D371529
...
namespace ENTITY
{
	...
	static BOOL DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Entity entity, BOOL p2) { return invoke<BOOL>(0xDDE6DF5AE89981D2, entity, p2); } // 0xDDE6DF5AE89981D2 0xACFEB3F9
	...
	static Hash* HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(char* entity) { return invoke<Hash*>(0x95EB9964FF5C5C65, entity); } // 0x95EB9964FF5C5C65 0x6B74582E
	...
	static void _SET_USED_BY_PLAYER(Entity entity, BOOL toggle) { invoke<Void>(0x694E00132F2823ED, entity, toggle); } // 0x694E00132F2823ED 0x40C84A74
	...
	static BOOL PLAY_SYNCHRONIZED_ENTITY_ANIM(Entity entity, int SceneID, char* animName, char* animDict, float speed, float speedMult, int flag, float flag2) { return invoke<BOOL>(0xC77720A12FE14A86, entity, SceneID, animName, animDict, speed, speedMult, flag, flag2); } // 0xC77720A12FE14A86 0x012760AA
	static BOOL PLAY_SYNCHRONIZED_MAP_ENTITY_ANIM(float posX, float posY, float posZ, float radius, Object prop, int sceneID, char* animName, char* animDict, float playbackRate, float unkFlag, BOOL unkBool, float unkFlag2) { return invoke<BOOL>(0xB9C54555ED30FBC4, posX, posY, posZ, radius, prop, sceneID, animName, animDict, playbackRate, unkFlag, unkBool, unkFlag2); } // 0xB9C54555ED30FBC4 0xEB4CBA74
	static BOOL STOP_SYNCHRONIZED_MAP_ENTITY_ANIM(float posX, float posY, float posZ, float radius, Object object, float playbackRate) { return invoke<BOOL>(0x11E79CAB7183B6F5, posX, posY, posZ, radius, object, playbackRate); } // 0x11E79CAB7183B6F5 0x7253D5B2
	...
	static void SET_ENTITY_ONLY_DAMAGED_BY_RELATIONSHIP_GROUP(Entity entity, BOOL p1, Hash relationshipHash) { invoke<Void>(0x7022BD828FA0B082, entity, p1, relationshipHash); } // 0x7022BD828FA0B082 0x202237E2
	...
	static void SET_ENTITY_ALPHA(Entity entity, int alphaLevel, BOOL unk) { invoke<Void>(0x44A0870B7E92D7C0, entity, alphaLevel, unk); } // 0x44A0870B7E92D7C0 0xAE667CB0
	...
	static void REMOVE_MODEL_HIDE(float x, float y, float z, float radius, Hash model, BOOL p5) { invoke<Void>(0xD9E3006FB3CBD765, x, y, z, radius, model, p5); } // 0xD9E3006FB3CBD765 0x993DBC10
	...
	static void REMOVE_FORCED_OBJECT(float posX, float posY, float posZ, float unk, Hash modelHash) { invoke<Void>(0x61B6775E83C0DB6F, posX, posY, posZ, unk, modelHash); } // 0x61B6775E83C0DB6F 0xAED73ADD
...
namespace PED
{
	...
	static void SET_PED_MIN_GROUND_TIME_FOR_STUNGUN(Ped ped, int ms1000000) { invoke<Void>(0xFA0675AB151073FA, ped, ms1000000); } // 0xFA0675AB151073FA 0x2F0D0973
	...
	static Any SET_PED_PINNED_DOWN(Ped player, BOOL pinned, int p2) { return invoke<Any>(0xAAD6D1ACF08F4612, player, pinned, p2); } // 0xAAD6D1ACF08F4612 0xCC78999D
	...
	static BOOL _IS_ENEMY_IN_RANGE(Ped ped, float x, float y, float z, float range) { return invoke<BOOL>(0x336B3D200AB007CB, ped, x, y, z, range); } // 0x336B3D200AB007CB 0xFB18CB19
	...
	static void RESET_GROUP_FORMATION_DEFAULT_SPACING(int groupId) { invoke<Void>(0x63DAB4CCB3273205, groupId); } // 0x63DAB4CCB3273205 0x267FCEAD
	...
	static void APPLY_DAMAGE_TO_PED(Ped ped, int damageAmount, BOOL armorFirst) { invoke<Void>(0x697157CED63F18D4, ped, damageAmount, armorFirst); } // 0x697157CED63F18D4 0x4DC27FCF
	...
	static void _SET_PED_COVER_CLIPSET_OVERRIDE(Ped ped, char* clipset) { invoke<Void>(0x9DBA107B4937F809, ped, clipset); } // 0x9DBA107B4937F809
	static void _CLEAR_PED_COVER_CLIPSET_OVERRIDE(Ped ped) { invoke<Void>(0xC79196DCB36F6121, ped); } // 0xC79196DCB36F6121
	...
	static void SET_PED_BLEND_FROM_PARENTS(Ped ped, Ped father, Ped mother, float fathersSide, float mothersSide) { invoke<Void>(0x137BBD05230DB22D, ped, father, mother, fathersSide, mothersSide); } // 0x137BBD05230DB22D 0x837BD370
	...
	static void _GET_HAIR_COLOR(int colorID, int* R, int* G, int* B) { invoke<Void>(0x4852FC386E2E1BB5, colorID, R, G, B); } // 0x4852FC386E2E1BB5
	static void _GET_LIPSTICK_COLOR(int colorID, int* R, int* G, Any* B) { invoke<Void>(0x013E5CFC38CD5387, colorID, R, G, B); } // 0x013E5CFC38CD5387
	static BOOL _0xED6D8E27A43B8CDE(int ColorID) { return invoke<BOOL>(0xED6D8E27A43B8CDE, ColorID); } // 0xED6D8E27A43B8CDE
	...
	static void KNOCK_OFF_PED_PROP(Ped ped, BOOL p1, BOOL knockOff, BOOL p2, BOOL p3) { invoke<Void>(0x6FD7816A36615F48, ped, p1, knockOff, p2, p3); } // 0x6FD7816A36615F48 0x08D8B180
	...
	static void SET_DRIVER_RACING_MODIFIER(Ped driver, float racingModifier) { invoke<Void>(0xDED5AF5A0EA4B297, driver, racingModifier); } // 0xDED5AF5A0EA4B297 0x6D55B3B3
	...
	static void APPLY_PED_BLOOD_SPECIFIC(Ped ped, Any p1, float xOffset, float yOffset, float zOffset, float scale, Any p6, float p7, char* bloodType) { invoke<Void>(0xEF0D582CBF2D9B0F, ped, p1, xOffset, yOffset, zOffset, scale, p6, p7, bloodType); } // 0xEF0D582CBF2D9B0F 0xFC13CE80
	...
	static void REMOVE_SCENARIO_BLOCKING_AREA(int areaHandle, BOOL p1) { invoke<Void>(0x31D16B74C6E29D66, areaHandle, p1); } // 0x31D16B74C6E29D66 0x4483EF06
	...
	static void SET_PED_RESET_FLAG(Ped ped, int flagId, BOOL value) { invoke<Void>(0xC1E8A365BF3B29F2, ped, flagId, value); } // 0xC1E8A365BF3B29F2 0xCFF6FF66
	...
	static BOOL _0x451294E859ECC018(int p0) { return invoke<BOOL>(0x451294E859ECC018, p0); } // 0x451294E859ECC018 0x8A3A3116
	...
	static void SET_PED_CAN_PEEK_IN_COVER(Ped player, BOOL aim) { invoke<Void>(0xC514825C507E3736, player, aim); } // 0xC514825C507E3736 0xC1DAE216
	...
	static void _TRACK_PED_VISIBILITY(Ped ped) { invoke<Void>(0x7D7A2E43E74E2EB8, ped); } // 0x7D7A2E43E74E2EB8 0x840D24D3
	...
	static void _0x2B5AA717A181FB4C(Ped ped, BOOL p1) { invoke<Void>(0x2B5AA717A181FB4C, ped, p1); } // 0x2B5AA717A181FB4C 0x98E29ED0
	static BOOL _0xB8B52E498014F5B0(Ped ped) { return invoke<BOOL>(0xB8B52E498014F5B0, ped); } // 0xB8B52E498014F5B0
	static int CREATE_SYNCHRONIZED_SCENE(float posX, float posY, float posZ, float roll, float pitch, float yaw, int p6) { return invoke<int>(0x8C18E0F9080ADD73, posX, posY, posZ, roll, pitch, yaw, p6); } // 0x8C18E0F9080ADD73 0xFFDDF8FA
	...
	static void SET_SYNCHRONIZED_SCENE_ORIGIN(int sceneID, float x, float y, float z, float roll, float pitch, float yaw, int unk) { invoke<Void>(0x6ACF6B7225801CD7, sceneID, x, y, z, roll, pitch, yaw, unk); } // 0x6ACF6B7225801CD7 0x2EC2A0B2
	...
	static void _SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(int sceneID, BOOL p1) { invoke<Void>(0x394B9CD12435C981, sceneID, p1); } // 0x394B9CD12435C981 0x2DE48DA1
	static BOOL _0x7F2F4F13AC5257EF(int SceneID) { return invoke<BOOL>(0x7F2F4F13AC5257EF, SceneID); } // 0x7F2F4F13AC5257EF 0x72CF2514
	...
	static Any GET_QUADBIKE_DISPLAY_VARIATIONS(Any p0) { return invoke<Any>(0x953563CE563143AF, p0); } // 0x953563CE563143AF 0x4DD03628
...
namespace VEHICLE
{
	...
	static Vehicle erstelle_fahr(Hash modelHash, float x, float y, float z, float heading, BOOL isNetwork, BOOL thisScriptCheck) { return invoke<Vehicle>(0xAF35D0D2583051B0, modelHash, x, y, z, heading, isNetwork, thisScriptCheck); } // 0xAF35D0D2583051B0 0xDD75460A
	...
	static void SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(float minX, float minY, float minZ, float maxX, float maxY, float maxZ, BOOL p6, BOOL p7) { invoke<Void>(0xC12321827687FE4D, minX, minY, minZ, maxX, maxY, maxZ, p6, p7); } // 0xC12321827687FE4D 0xB4E0E69A
	...
	static Any SET_ALL_VEHICLES_SPAWN(Vehicle vehicle, BOOL p1, BOOL p2, BOOL p3) { return invoke<Any>(0xE023E8AC4EF7C117, vehicle, p1, p2, p3); } // 0xE023E8AC4EF7C117 0xA0909ADB
	...
	static void ADD_VEHICLE_PHONE_EXPLOSIVE_DEVICE(Vehicle vehicle) { invoke<Void>(0x99AD4CCCB128CBC9, vehicle); } // 0x99AD4CCCB128CBC9 0x811373DE
	static BOOL HAS_VEHICLE_PHONE_EXPLOSIVE_DEVICE() { return invoke<BOOL>(0x6ADAABD3068C5235); } // 0x6ADAABD3068C5235 0xA4E69134
	static void DETONATE_VEHICLE_PHONE_EXPLOSIVE_DEVICE() { invoke<Void>(0xEF49CF0270307CBE); } // 0xEF49CF0270307CBE 0x65255524
	...
	static void _0x8F719973E1445BA2(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x8F719973E1445BA2, vehicle, toggle); } // 0x8F719973E1445BA2 0x35614622
	...
	static void BRING_VEHICLE_TO_HALT(Vehicle vehicle, float distance, int duration, BOOL unknown) { invoke<Void>(0x260BE8F09E326A20, vehicle, distance, duration, unknown); } // 0x260BE8F09E326A20 0xCBC7D3C8
	static void _SET_VEHICLE_FORKLIFT_HEIGHT(Vehicle vehicle, float height) { invoke<Void>(0x37EBBF3117BD6A25, vehicle, height); } // 0x37EBBF3117BD6A25 0x943A6CFC
	...
	static int GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(Vehicle elegy) { return invoke<int>(0xF11BC2DD9A3E7195, elegy); } // 0xF11BC2DD9A3E7195 0x499747B6
	...
	static float GET_TOTAL_DURATION_OF_VEHICLE_RECORDING_ID(int recordingID) { return invoke<float>(0x102D125411A7B6E6, recordingID); } // 0x102D125411A7B6E6 0x7116785E
	...
	static void _0x1F2E4E06DEA8992B(Vehicle p0, BOOL p1) { invoke<Void>(0x1F2E4E06DEA8992B, p0, p1); } // 0x1F2E4E06DEA8992B 0x01B91CD0
	static void STOP_PLAYBACK_RECORDED_VEHICLE(Vehicle vehicle) { invoke<Void>(0x54833611C17ABDEA, vehicle); } // 0x54833611C17ABDEA 0xAE99C57C
	...
	static BOOL IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Vehicle vehicle) { return invoke<BOOL>(0x1C8A4C2C19E68EEC, vehicle); } // 0x1C8A4C2C19E68EEC 0x61F7650D
	...
	static int GET_CURRENT_PLAYBACK_FOR_VEHICLE(Vehicle vehicle) { return invoke<int>(0x42BC05C27A946054, vehicle); } // 0x42BC05C27A946054 0xA3F44390
	...
	static BOOL IS_VEHICLE_DOOR_FULLY_OPEN(Vehicle v, int doorIndex) { return invoke<BOOL>(0x3E933CFF7B111C22, v, doorIndex); } // 0x3E933CFF7B111C22 0xC2385B6F
	static void SET_VEHICLE_ENGINE_ON(Vehicle vehicle, BOOL value, BOOL instantly, BOOL noAutoTurnOn) { invoke<Void>(0x2497C4717C8B881E, vehicle, value, instantly, noAutoTurnOn); } // 0x2497C4717C8B881E 0x7FBC86F1
	...
	static void SET_VEHICLE_DOOR_LATCHED(Vehicle vehicle, int doorIndex, BOOL forceClose, BOOL lock, BOOL p4) { invoke<Void>(0xA5A9653A8D2CAF48, vehicle, doorIndex, forceClose, lock, p4); } // 0xA5A9653A8D2CAF48 0x4EB7BBFC
	...
	static BOOL IS_VEHICLE_BUMPER_BOUNCING(Vehicle vehicle, BOOL frontBumper) { return invoke<BOOL>(0x27B926779DEB502D, vehicle, frontBumper); } // 0x27B926779DEB502D 0xB3A2CC4F
	...
	static void SET_VEHICLE_LIVERY(Vehicle vehicle, int liveryIndex) { invoke<Void>(0x60BF608F1B8CD1B6, vehicle, liveryIndex); } // 0x60BF608F1B8CD1B6 0x7AD87059
	static int GET_VEHICLE_LIVERY(Vehicle trailers2) { return invoke<int>(0x2BB9230590DA5E8A, trailers2); } // 0x2BB9230590DA5E8A 0xEC82A51D
	...
	static void SET_VEHICLE_BRAKE_LIGHTS(Vehicle vehicle, BOOL p1) { invoke<Void>(0x92B35082E0B42F66, vehicle, p1); } // 0x92B35082E0B42F66 0x6D9BA11E
	...
	static void _0xCAC66558B944DA67(char* vehicle, BOOL p1) { invoke<Void>(0xCAC66558B944DA67, vehicle, p1); } // 0xCAC66558B944DA67 0x0B200CE2
	static void SET_VEHICLE_RUDDER_BROKEN(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x09606148B6C71DEF, vehicle, toggle); } // 0x09606148B6C71DEF 0x3FAC3CD4
	...
	static float _GET_VEHICLE_MODEL_MAX_KNOTS(Hash modelHash) { return invoke<float>(0xC6AD107DDC9054CC, modelHash); } // 0xC6AD107DDC9054CC 0x95BB67EB
	...
	static BOOL CAN_SHUFFLE_SEAT(Vehicle vehicle, Ped ped) { return invoke<BOOL>(0x30785D90C956BF35, vehicle, ped); } // 0x30785D90C956BF35 0xB3EB01ED
	...
	static void GET_VEHICLE_MOD_COLOR_1(Vehicle vehicle, int* paintType, int* color, int* pearlescentColor) { invoke<Void>(0xE8D65CA700C9A693, vehicle, paintType, color, pearlescentColor); } // 0xE8D65CA700C9A693 0xE625510A
	...
	static BOOL _IS_ANY_PASSENGER_RAPPELLING(Vehicle vehicle) { return invoke<BOOL>(0x291E373D483E7EE7, vehicle); } // 0x291E373D483E7EE7 0xD656E7E5
	...
	static void _0x4D9D109F63FEE1D4(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x4D9D109F63FEE1D4, vehicle, toggle); } // 0x4D9D109F63FEE1D4 0x900C878C
	...
	static void SET_FORCE_HD_VEHICLE(Vehicle vehicle, Blip* toggle) { invoke<Void>(0x97CE68CB032583F0, vehicle, toggle); } // 0x97CE68CB032583F0 0xE0FC6A32
	...
	static void _0x0CDDA42F9E360CA6(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x0CDDA42F9E360CA6, vehicle, toggle); } // 0x0CDDA42F9E360CA6 0x9B581DE7
	...
	static void SET_PLANE_TURBULENCE_MULTIPLIER(Vehicle plane, float multiplier) { invoke<Void>(0xAD2D28A1AFDFF131, plane, multiplier); } // 0xAD2D28A1AFDFF131 0xED159AE6
	...
	static void CREATE_PICK_UP_ROPE_FOR_CARGOBOB(Vehicle cargobob, int state) { invoke<Void>(0x1FF712BDAC7F1F27, cargobob, state); } // 0x7BEB0C7A235F6F3B 0x4D3C9A99
	...
	static void _SET_CARGOBOB_HOOK_POSITION(Vehicle cargobob, float xOffset, float yOffset, int state) { invoke<Void>(0x877C1EAEAC531023, cargobob, xOffset, yOffset, state); } // 0x877C1EAEAC531023 0x3A8AB081
	...
	static void _SET_CARGOBOB_PICKUP_MAGNET_ACTIVE(Vehicle cargobob, BOOL isActive) { invoke<Void>(0x84FF99D7BD294C6F, cargobob, isActive); } // 0x9A665550F8DA349B
	static void _SET_CARGOBOB_PICKUP_MAGNET_STRENGTH(Vehicle cargobob, float strength) { invoke<Void>(0xBA27CCFA070B87D1, cargobob, strength); } // 0xBCBFCD9D1DAC19E2	static void _0xA17BAD153B51547E(Vehicle cargobob, float p1) { invoke<Void>(0xA17BAD153B51547E, cargobob, p1); } // 0xA17BAD153B51547E
	...
	static void _SET_HELICOPTER_ROLL_PITCH_YAW_MULT_HEALTH(Vehicle helicopter, float multiplier) { invoke<Void>(0x6E0859B530A365CC, helicopter, multiplier); } // 0x6E0859B530A365CC 0x6E67FD35
	...
	static void SET_DISTANT_CARS_ENABLED(BOOL toggle) { invoke<Void>(0xF796359A959DF65D, toggle); } // 0xF796359A959DF65D 0xB5CC548B
	...
	static void _REQUEST_VEHICLE_SCALEFORM_MOVIE(Vehicle vehicle) { invoke<Void>(0xDBA3C090E3D74690, vehicle); } // 0xDBA3C090E3D74690
...
namespace OBJECT
{
	...
	static Pickup pockup(Hash pickupHash, float posX, float posY, float posZ, int flag, int value, Hash modelHash, BOOL returnHandle, BOOL p8) { return invoke<Pickup>(0x673966A0C0FD7171, pickupHash, posX, posY, posZ, flag, value, modelHash, returnHandle, p8); } // 0x673966A0C0FD7171 0x17B99CE7
	...
	static void _SET_OBJECT_LOD(Object object, BOOL toggle) { invoke<Void>(0x77F33F2CCF64B3AA, object, toggle); } // 0x77F33F2CCF64B3AA 0x483C5C88
	...
	static Pickup CREATE_AMBIENT_PICKUP(Hash pickupHash, float posX, float posY, float posZ, int flag, int value, Hash modelHash, BOOL returnHandle, BOOL p8) { return invoke<Pickup>(0x673966A0C0FD7171, pickupHash, posX, posY, posZ, flag, value, modelHash, returnHandle, p8); } // 0x673966A0C0FD7171 0x17B99CE7
	...
	static void CREATE_MONEY_PICKUPS(float x, float y, float z, int value, int amount, Hash model) { invoke<Void>(0xE92467219E1F8814, x, y, z, value, amount, model); } // 0x0589B5E791CE9B2B 0x36C9A5EA
	...
	static int* _0xDB41D07A45A6D4B7(Hash pickupHash) { return invoke<int*>(0xDB41D07A45A6D4B7, pickupHash); } // 0xDB41D07A45A6D4B7 0x000E92DC
...
namespace AI
{
	static void TASK_PAUSE(Ped ped, int time) { invoke<Void>(0xE73A266DB0CA9042, ped, time); } // 0xE73A266DB0CA9042 0x17A64668
	...
	static void TASK_AIM_GUN_AT_ENTITY(Ped ped, Entity entity, int duration, BOOL unk) { invoke<Void>(0x9B53BB6E8943AF53, ped, entity, duration, unk); } // 0x9B53BB6E8943AF53 0xBE32B3B6
	...
	static void TASK_CHAT_TO_PED(Ped ped, Ped target, int p2, float p3, float p4, float p5, float p6, float p7) { invoke<Void>(0x8C338E0263E4FD19, ped, target, p2, p3, p4, p5, p6, p7); } // 0x8C338E0263E4FD19 0xA2BE1821
	...
	static void TASK_PERFORM_SEQUENCE_FROM_PROGRESS(Ped ped, Object taskSequence, int currentProgress, int progressToSetTo) { invoke<Void>(0x89221B16730234F0, ped, taskSequence, currentProgress, progressToSetTo); } // 0x89221B16730234F0 0xFA60601B
	...
	static Any ADD_COVER_POINT(float posX, float posY, float posZ, float heading, BOOL p4, int p5, BOOL p6, BOOL p7) { return invoke<Any>(0xD5C12A75C7B9497F, posX, posY, posZ, heading, p4, p5, p6, p7); } // 0xD5C12A75C7B9497F 0xA0AF0B98
	...
	static void TASK_COMBAT_PED_TIMED(Any p0, Ped ped, int duration, Any p3) { invoke<Void>(0x944F30DCB7096BDE, p0, ped, duration, p3); } // 0x944F30DCB7096BDE 0xF5CA2A45
	...
	static void TASK_EXIT_COVER(Ped ped, int p1, float posX, float posY, float posZ) { invoke<Void>(0x79B258E397854D29, ped, p1, posX, posY, posZ); } // 0x79B258E397854D29 0xC829FAC9
	static void TASK_PUT_PED_DIRECTLY_INTO_MELEE(Ped ped, Ped target, float p2, float p3, float p4, float flag) { invoke<Void>(0x1C6CD14A876FFE39, ped, target, p2, p3, p4, flag); } // 0x1C6CD14A876FFE39 0x79E1D27D
	...
	static BOOL IS_SCENARIO_OCCUPIED(float x, float y, float z, float radius, BOOL p4) { return invoke<BOOL>(0x788756D73AC2E07C, x, y, z, radius, p4); } // 0x788756D73AC2E07C 0x697FC008
	...
	static void TASK_VEHICLE_SHOOT_AT_PED(Ped ped, Ped target, float flag) { invoke<Void>(0x10AB107B887214D8, ped, target, flag); } // 0x10AB107B887214D8 0x59677BA0
	...
	static float GET_PED_WAYPOINT_DISTANCE(Ped ped) { return invoke<float>(0xE6A877C64CAF1BC5, ped); } // 0xE6A877C64CAF1BC5 0x084B35B0
	static Any SET_PED_WAYPOINT_ROUTE_OFFSET(Ped ped, float offsetX, float offsetY, float offsetZ) { return invoke<Any>(0xED98E10B0AFCE4B4, ped, offsetX, offsetY, offsetZ); } // 0xED98E10B0AFCE4B4 0xF867F747
	...
	static void _WAYPOINT_PLAYBACK_START_SHOOTING_AT_PED(Any p0, Any p1, BOOL p2, Any p3) { invoke<Void>(0xE70BA7B90F8390DC, p0, p1, p2, p3); } // 0xE70BA7B90F8390DC
	...
	static Any GET_VEHICLE_WAYPOINT_TARGET_POINT(Ped ped) { return invoke<Any>(0x416B62AC8B9E5BBD, ped); } // 0x416B62AC8B9E5BBD 0x81049608
	...
	static BOOL _0x921CE12C489C4C41(Ped handle) { return invoke<BOOL>(0x921CE12C489C4C41, handle); } // 0x921CE12C489C4C41 0x902656EB
	...
	static Any _0xAB13A5565480B6D9(Ped ped, char* unk) { return invoke<Any>(0xAB13A5565480B6D9, ped, unk); } // 0xAB13A5565480B6D9
	...
	static void TASK_SWEEP_AIM_ENTITY(Ped ped, char* animDict, char* animName1, char* animName2, char* animName3, int duration, Entity entity, float p7, float p8) { invoke<Void>(0x2047C02158D6405A, ped, animDict, animName1, animName2, animName3, duration, entity, p7, p8); } // 0x2047C02158D6405A 0x4D210467
	...
	static void TASK_SWEEP_AIM_POSITION(Ped ped, char* animDict, char* animName1, char* animName2, char* animName3, int timeout, float X, float Y, float Z, float unk, float flag) { invoke<Void>(0x7AFE8FDC10BC07D2, ped, animDict, animName1, animName2, animName3, timeout, X, Y, Z, unk, flag); } // 0x7AFE8FDC10BC07D2 0x1683FE66
	static void UPDATE_TASK_SWEEP_AIM_POSITION(Ped ped, float X, float Y, float Z) { invoke<Void>(0xBB106883F5201FC4, ped, X, Y, Z); } // 0xBB106883F5201FC4 0x6345EC80
...
namespace GAMEPLAY
{
	...
	static int _GET_FREE_STACK_SLOTS_COUNT(int threadId) { return invoke<int>(0xFEAD16FC8F9DFC0F, threadId); } // 0xFEAD16FC8F9DFC0F 0x11A178B8
	...
	static BOOL GET_RANDOM_EVENT_FLAG() { return invoke<BOOL>(0xD2D57F1D764117B1); } // 0xD2D57F1D764117B1 0x794CC92C
	...
	static float GET_RAIN_LEVEL() { return invoke<float>(0x96695E368AD855F3); } // 0x96695E368AD855F3 0xC9F67F28
	static float GET_SNOW_LEVEL() { return invoke<float>(0xC5868A966E5BE3AE); } // 0xC5868A966E5BE3AE 0x1B09184F
	...
	static void PRELOAD_CLOUD_HAT(char* name) { invoke<Void>(0x11B56FBBF7224868, name); } // 0x11B56FBBF7224868 0x8727A4C5
	static void LOAD_CLOUD_HAT(char* name, float transitionTime) { invoke<Void>(0xFC4842A34657BFCB, name, transitionTime); } // 0xFC4842A34657BFCB 0xED88FC61
	static void UNLOAD_CLOUD_HAT(char* name, float p1) { invoke<Void>(0xA74802FB8D0B7814, name, p1); } // 0xA74802FB8D0B7814 0xC9FA6E07
	...
	static BOOL HAVE_CREDITS_REACHED_END() { return invoke<BOOL>(0x075F1D57402C93BA); } // 0x075F1D57402C93BA 0x2569C9A7
	...
	static void SET_SAVE_HOUSE(int index, BOOL p1, BOOL p2) { invoke<Void>(0x4F548CABEAE553BC, index, p1, p2); } // 0x4F548CABEAE553BC 0xC3240BB4
	...
	static void ADD_REPLAY_STAT_VALUE(Any value) { invoke<Void>(0x69FE6DC87BD2A5E9, value); } // 0x69FE6DC87BD2A5E9 0x81216EE0
	...
	static BOOL _0xD3D15555431AB793() { return invoke<BOOL>(0xD3D15555431AB793); } // 0xD3D15555431AB793 0xBAF17315
	...
	static BOOL IS_PROJECTILE_TYPE_WITHIN_DISTANCE(float x, float y, float z, Hash projHash, float radius, BOOL ownedByPlayer) { return invoke<BOOL>(0x34318593248C8FB2, x, y, z, projHash, radius, ownedByPlayer); } // 0x34318593248C8FB2 0xBE81F1E2
	static BOOL _GET_IS_PROJECTILE_TYPE_IN_AREA(float x1, float y1, float z1, float x2, float y2, float z2, Hash projHash, Vector3* projPos, BOOL ownedByPlayer) { return invoke<BOOL>(0x8D7A43EC6A5FEA45, x1, y1, z1, x2, y2, z2, projHash, projPos, ownedByPlayer); } // 0x8D7A43EC6A5FEA45 0x1A40454B
	static BOOL _GET_PROJECTILE_NEAR_PED_COORDS(Ped ped, Hash projHash, float radius, Vector3* projPos, BOOL ownedByPlayer) { return invoke<BOOL>(0xDFB4138EEFED7B81, ped, projHash, radius, projPos, ownedByPlayer); } // 0xDFB4138EEFED7B81 0x6BDE5CE4
	static BOOL _GET_PROJECTILE_NEAR_PED(Ped ped, Hash projHash, float radius, Vector3* projPos, Entity* projEnt, BOOL ownedByPlayer) { return invoke<BOOL>(0x82FDE6A57EE4EE44, ped, projHash, radius, projPos, projEnt, ownedByPlayer); } // 0x82FDE6A57EE4EE44 0x507BC6F7
	...
	static void DELETE_STUNT_JUMP(int player) { invoke<Void>(0xDC518000E39DAE1F, player); } // 0xDC518000E39DAE1F 0x840CB5DA
	...
	static int _0x996DD1E1E02F1008() { return invoke<int>(0x996DD1E1E02F1008); } // 0x996DD1E1E02F1008 0x006F9BA2
	...
	static int _0xA09F896CE912481F(BOOL p0) { return invoke<int>(0xA09F896CE912481F, p0); } // 0xA09F896CE912481F 0x9EF0BC64
	...
	static BOOL _HAS_ALL_CHUNKS_ON_HDD() { return invoke<BOOL>(0x14832BF2ABA53FC5); } // 0x14832BF2ABA53FC5
	static void _CLEANUP_ASYNC_INSTALL() { invoke<Void>(0xC79AE21974B01FB2); } // 0xC79AE21974B01FB2
	...
	static void _SET_SHOW_PED_IN_PAUSE_MENU(BOOL toggle) { invoke<Void>(0x4EBB7E87AA0DBED4, toggle); } // 0x4EBB7E87AA0DBED4
	static BOOL _GET_SHOW_PED_IN_PAUSE_MENU() { return invoke<BOOL>(0x9689123E3F213AA5); } // 0x9689123E3F213AA5
...
namespace AUDIO
{
	...
	static BOOL _0xC8B1B2425604CDD0() { return invoke<BOOL>(0xC8B1B2425604CDD0); } // 0xC8B1B2425604CDD0 0x16FB88B5
	...
	static void ADD_PED_TO_CONVERSATION(int pedIndex, Ped ped, char* name) { invoke<Void>(0x95D9F4BC443956E7, pedIndex, ped, name); } // 0x95D9F4BC443956E7 0xF8D5EB86
	...
	static BOOL _0xE73364DB90778FFA() { return invoke<BOOL>(0xE73364DB90778FFA); } // 0xE73364DB90778FFA 0x336F3D35
	...
	static void SET_VARIABLE_ON_SOUND(int soundId, char* variableName, float value) { invoke<Void>(0xAD6B3148A78AE9B6, soundId, variableName, value); } // 0xAD6B3148A78AE9B6 0x606EE5FA
	...
	static void _PLAY_AMBIENT_SPEECH_AT_COORDS(char* speechName, char* voiceName, float x, float y, float z, char* speechParam) { invoke<Void>(0xED640017ED337E45, speechName, voiceName, x, y, z, speechParam); } // 0xED640017ED337E45 0xA1A1402E
	static void OVERRIDE_TREVOR_RAGE(char* p0) { invoke<Void>(0x13AD665062541A7E, p0); } // 0x13AD665062541A7E 0x05B9B5CF
	static void RESET_TREVOR_RAGE() { invoke<Void>(0xE78503B10C4314E0); } // 0xE78503B10C4314E0 0xE80CF0D4
	static void SET_PLAYER_ANGRY(Ped playerPed, BOOL value) { invoke<Void>(0xEA241BB04110F091, playerPed, value); } // 0xEA241BB04110F091 0x782CA58D
	static void PLAY_PAIN(Ped ped, int painID, float p1) { invoke<Void>(0xBC9AE166038A5CEC, ped, painID, p1); } // 0xBC9AE166038A5CEC 0x874BD6CB
	...
	static void _RESET_AMBIENT_VOICE(Ped ped) { invoke<Void>(0x40CF0D12D142A9E8, ped); } // 0x40CF0D12D142A9E8
	...
	static BOOL _0x0626A247D2405330() { return invoke<BOOL>(0x0626A247D2405330); } // 0x0626A247D2405330
	...
	static void _SET_VEHICLE_AS_AMBIENT_EMMITTER(Vehicle vehicle) { invoke<Void>(0xC1805D05E6D4FE10, vehicle); } // 0xC1805D05E6D4FE10 0x7ABB89D2
	...
	static void SET_AMBIENT_ZONE_LIST_STATE(char* p0, BOOL p1, BOOL p2) { invoke<Void>(0x9748FA4DE50CCE3E, p0, p1, p2); } // 0x9748FA4DE50CCE3E 0xBF80B412
	...
	static void STOP_PED_SPEAKING(Ped ped, BOOL speaking) { invoke<Void>(0x9D64D7405520E3D3, ped, speaking); } // 0x9D64D7405520E3D3 0xFF92B49D
	...
	static BOOL _0x6F259F82D873B8B8() { return invoke<BOOL>(0x6F259F82D873B8B8); } // 0x6F259F82D873B8B8 0xCBE09AEC
	...
	static BOOL AUDIO_IS_SCRIPTED_MUSIC_PLAYING() { return invoke<BOOL>(0x845FFC3A4FEEFA3E); } // 0x845FFC3A4FEEFA3E 0x86E995D1
	...
	static Any PREPARE_SYNCHRONIZED_AUDIO_EVENT(char* audioName, BOOL unk) { return invoke<Any>(0xC7ABCACA4985A766, audioName, unk); } // 0xC7ABCACA4985A766 0xE1D91FD0
	static BOOL PREPARE_SYNCHRONIZED_AUDIO_EVENT_FOR_SCENE(int SceneID, char* audioName) { return invoke<BOOL>(0x029FE7CD1B7E2E75, SceneID, audioName); } // 0x029FE7CD1B7E2E75 0x7652DD49
	static BOOL PLAY_SYNCHRONIZED_AUDIO_EVENT(int SceneID) { return invoke<BOOL>(0x8B2FD4560E55DD2D, SceneID); } // 0x8B2FD4560E55DD2D 0x507F3241
	static BOOL STOP_SYNCHRONIZED_AUDIO_EVENT(int SceneID) { return invoke<BOOL>(0x92D6A88E64A94430, SceneID); } // 0x92D6A88E64A94430 0xADEED2B4
	...
	static BOOL _0x3A48AB4445D499BE() { return invoke<BOOL>(0x3A48AB4445D499BE); } // 0x3A48AB4445D499BE 0x93A44A1F
	...
	static BOOL _0x544810ED9DB6BBE6() { return invoke<BOOL>(0x544810ED9DB6BBE6); } // 0x544810ED9DB6BBE6
	static BOOL _0x5B50ABB1FE3746F4() { return invoke<BOOL>(0x5B50ABB1FE3746F4); } // 0x5B50ABB1FE3746F4
}
...
namespace CUTSCENE
{
	...
	static void _0x011883F41211432A(float x1, float y1, float z1, float x2, float y2, float z2, int p6) { invoke<Void>(0x011883F41211432A, x1, y1, z1, x2, y2, z2, p6); } // 0x011883F41211432A
...
namespace CAM
{
	...
	static Cam CREATE_CAM(char* camName, BOOL unk) { return invoke<Cam>(0xC3981DCE61D9E13F, camName, unk); } // 0xC3981DCE61D9E13F 0xE9BF2A7D
	...
	static void SET_CAM_ROT(Cam cam, float pitch, float roll, float yaw, int rotationOrder) { invoke<Void>(0x85973643155D0B07, cam, pitch, roll, yaw, rotationOrder); } // 0x85973643155D0B07 0xEE38B3C1
	...
	static void ADD_CAM_SPLINE_NODE(Cam camera, float x, float y, float z, float xRot, float yRot, float zRot, int length, int p8, int transitionType) { invoke<Void>(0x8609C75EC438FB3B, camera, x, y, z, xRot, yRot, zRot, length, p8, transitionType); } // 0x8609C75EC438FB3B 0xAD3C7EAA
	...
	static int GET_CAM_SPLINE_NODE_INDEX(Cam cam) { return invoke<int>(0xB22B17DF858716A6, cam); } // 0xB22B17DF858716A6 0xF8AEB6BD
	...
	static BOOL PLAY_SYNCHRONIZED_CAM_ANIM(Cam camera, int SceneID, char* animName, char* animDictionary) { return invoke<BOOL>(0xE32EFE9AB4A9AA0C, camera, SceneID, animName, animDictionary); } // 0xE32EFE9AB4A9AA0C 0x9458459E
	...
	static void SET_WIDESCREEN_BORDERS(BOOL toggle, int duration) { invoke<Void>(0xDCD4EA924F42D01A, toggle, duration); } // 0xDCD4EA924F42D01A 0x1A75DC9A
	...
	static void _SET_FIRST_PERSON_CAM_PITCH_RANGE(float minAngle, float maxAngle) { invoke<Void>(0xBCFC632DB7673BF0, minAngle, maxAngle); } // 0xBCFC632DB7673BF0 0x76DAC96C
	static void _SET_FIRST_PERSON_CAM_NEAR_CLIP(float distance) { invoke<Void>(0x0AF7B437918103B3, distance); } // 0x0AF7B437918103B3 0x0E21069D
	static void _SET_THIRD_PERSON_AIM_CAM_NEAR_CLIP(float distance) { invoke<Void>(0x42156508606DE65E, distance); } // 0x42156508606DE65E 0x71E9C63E
	...
	static float _GET_GAMEPLAY_CAM_FAR_CLIP() { return invoke<float>(0xDFC8CBC606FDB0FC); } // 0xDFC8CBC606FDB0FC 0x46CB3A49
	static float _GET_GAMEPLAY_CAM_NEAR_DOF() { return invoke<float>(0xA03502FC581F7D9B); } // 0xA03502FC581F7D9B 0x19297A7A
	static float _GET_GAMEPLAY_CAM_FAR_DOF() { return invoke<float>(0x9780F32BCAF72431); } // 0x9780F32BCAF72431 0xF24777CA
	...
	static void SET_GAMEPLAY_VEHICLE_HINT(Vehicle p0, float xOffset, float yOffset, float zOffset, BOOL p4, int duration, int easeInDuration, int easeOutDuration) { invoke<Void>(0xA2297E18F3E71C2E, p0, xOffset, yOffset, zOffset, p4, duration, easeInDuration, easeOutDuration); } // 0xA2297E18F3E71C2E 0x2C9A11D8
	...
	static void SET_GAMEPLAY_ENTITY_HINT(Entity entity, float xOffset, float yOffset, float zOffset, BOOL p4, int duration, int fadeInTime, int fadeOutTime, int flags) { invoke<Void>(0x189E955A8313E298, entity, xOffset, yOffset, zOffset, p4, duration, fadeInTime, fadeOutTime, flags); } // 0x189E955A8313E298 0x66C32306
	...
	static float _GET_REPLAY_FREE_CAM_MAX_RANGE() { return invoke<float>(0x8BFCEB5EA1B161B6); } // 0x8BFCEB5EA1B161B6
}
...
namespace WEAPON
{
	...
	static void REMOVE_ALL_PED_WEAPONS(Ped ped, BOOL unused) { invoke<Void>(0xF25DF915FA38C5F3, ped, unused); } // 0xF25DF915FA38C5F3 0xA44CE817
	...
	static void SET_PED_AMMO_BY_TYPE(Ped ped, Hash ammoType, int ammo) { invoke<Void>(0x5FD1E1F011E76D7E, ped, ammoType, ammo); } // 0x5FD1E1F011E76D7E 0x311C52BB
	static int GET_PED_AMMO_BY_TYPE(Ped ped, Hash ammoType) { return invoke<int>(0x39D22031557946C1, ped, ammoType); } // 0x39D22031557946C1 0x54077C4D
	static void SET_PED_AMMO_TO_DROP(Any ammoType, int ammo) { invoke<Void>(0xA4EFEF9440A5B0EF, ammoType, ammo); } // 0xA4EFEF9440A5B0EF 0x2386A307
...
namespace STREAMING
{
	...
	static void REQUEST_MENU_PED_MODEL(Player model) { invoke<Void>(0xA0261AEF7ACFC51E, model); } // 0xA0261AEF7ACFC51E 0x48CEB6B4
	...
	static void REQUEST_NAMED_PTFX_ASSET(char* assetName) { invoke<Void>(0xB80D8756B4668AB6, assetName); } // 0xB80D8756B4668AB6 0xCFEA19A9
	static BOOL HAS_NAMED_PTFX_ASSET_LOADED(char* assetName) { return invoke<BOOL>(0x8702416E512EC454, assetName); } // 0x8702416E512EC454 0x9ACC6446
	static void _REMOVE_NAMED_PTFX_ASSET(char* assetName) { invoke<Void>(0x5F61EBBE1A00F96D, assetName); } // 0x5F61EBBE1A00F96D
	static void SET_VEHICLE_POPULATION_BUDGET(int budget) { invoke<Void>(0xCB9E1EB3BE2AF4E9, budget); } // 0xCB9E1EB3BE2AF4E9 0x1D56993C
	static void SET_PED_POPULATION_BUDGET(int budget) { invoke<Void>(0x8C95333CFC3340F3, budget); } // 0x8C95333CFC3340F3 0xD2D026CD
	...
	static BOOL _0x71E7B2E657449AAD() { return invoke<BOOL>(0x71E7B2E657449AAD); } // 0x71E7B2E657449AAD 0xEAA51103
	...
	static int _0x78C0D93253149435() { return invoke<int>(0x78C0D93253149435); } // 0x78C0D93253149435 0x02BA7AC2
	static void SET_PLAYER_SWITCH_OUTRO(float camCoordX, float camCoordY, float camCoordZ, float camRotX, float camRotY, float camRotZ, float camFOV, float camFarClip, int p8) { invoke<Void>(0xC208B673CE446B61, camCoordX, camCoordY, camCoordZ, camRotX, camRotY, camRotZ, camFOV, camFarClip, p8); } // 0xC208B673CE446B61 0x47352E14
	static void _0x0FDE9DBFC0A6BC65(char* p0) { invoke<Void>(0x0FDE9DBFC0A6BC65, p0); } // 0x0FDE9DBFC0A6BC65 0x279077B0
	...
	static void _SWITCH_OUT_PLAYER(Ped ped, int flags, int switchType) { invoke<Void>(0xAAB3200ED59016BC, ped, flags, switchType); } // 0xAAB3200ED59016BC 0xFB4D062D
	static void _SWITCH_IN_PLAYER(Ped ped) { invoke<Void>(0xD8295AF639FD9CB8, ped); } // 0xD8295AF639FD9CB8 0x2349373B
	static BOOL _0x933BBEEB8C61B5F4() { return invoke<BOOL>(0x933BBEEB8C61B5F4); } // 0x933BBEEB8C61B5F4 0x74C16879
...
namespace SCRIPT
{
	...
	static void SET_PLAYER_WEATHER(char a1, int a2, int a3, __int64 a4)
	{                                            //a2 = weatherID (1 - 15                                                
		static auto func = reinterpret_cast<void(*)(char, int, int, __int64)>(Memory::pattern("48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 57 48 83 EC 30 40 8A E9").count(1).get(0).get<void>(0));
		func(a1, a2, a3, a4);
	}
	...
	static void TRIGGER_SCRIPT_EVENT(int eventGroup, Any* args, int argCount, Any bit) { invoke<Void>(0x5AE99C571D5BBE5D, eventGroup, args, argCount, bit); } // 0x5AE99C571D5BBE5D 0x54763B35
...
namespace UI
{
	...
	static BOOL _0xA9CBFD40B3FA3010() { return invoke<BOOL>(0xA9CBFD40B3FA3010); } // 0xA9CBFD40B3FA3010 0xC5223796
	...
	static int _DRAW_NOTIFICATION(BOOL blink, BOOL showInBrief) { return invoke<int>(0x2ED7843F8F801023, blink, showInBrief); } // 0x2ED7843F8F801023 0x08F7AF78
	...
	static Any _0xC8F3AAF93D0600BF(char* p0, int p1, char* p2, Any p3) { return invoke<Any>(0xC8F3AAF93D0600BF, p0, p1, p2, p3); } // 0xC8F3AAF93D0600BF 0x4FA43BA4
	...
	static void END_TEXT_COMMAND_DISPLAY_HELP(Any p0, BOOL loop, BOOL beep, int duration) { invoke<Void>(0x238FFE5C7B0498A6, p0, loop, beep, duration); } // 0x238FFE5C7B0498A6 0xB59B530D
	...
	static void SET_TEXT_SCALE(float unk, float scale) { invoke<Void>(0x07C837F9A01C34C9, unk, scale); } // 0x07C837F9A01C34C9 0xB6E15B23
	...
	static void _0x75A16C3DA34F1245(Blip blip, BOOL p1) { invoke<Void>(0x75A16C3DA34F1245, blip, p1); } // 0x75A16C3DA34F1245 0x1D99F676
	static void SHOW_TICK_ON_BLIP(Blip blip, BOOL toggle) { invoke<Void>(0x74513EA3E505181E, blip, toggle); } // 0x74513EA3E505181E 0x3DCF0092
	...
	static Any SET_MINIMAP_COMPONENT(int component, BOOL toggle, int componentColor) { return invoke<Any>(0x75A9A10948D1DEA6, component, toggle, componentColor); } // 0x75A9A10948D1DEA6 0x419DCDC4
	...
	static void SET_RADAR_AS_INTERIOR_THIS_FRAME(Hash interior, float x, float y, int heading, int zoom) { invoke<Void>(0x59E727A1C9D3E31A, interior, x, y, heading, zoom); } // 0x59E727A1C9D3E31A 0x6F2626E1
	...
	static void _UPDATE_DISPLAY_CASH(BOOL toggle) { invoke<Void>(0x170F541E1CADD1DE, toggle); } // 0x170F541E1CADD1DE
	...
	static void _SET_DISPLAY_CASH() { invoke<Void>(0xC2D15BEF167E27BC); } // 0xC2D15BEF167E27BC 0xF4F3C796
	static void _REMOVE_DISPLAY_CASH() { invoke<Void>(0x95CF81BD06EE1887); } // 0x95CF81BD06EE1887 0x7BFFE82F
	...
	static void _BLOCK_WEAPON_WHEEL_THIS_FRAME() { invoke<Void>(0x0AFC4AF510774B47); } // 0x0AFC4AF510774B47 0xB26FED2B
	...
	static void SET_MINIMAP_GOLF_COURSE(int hole) { invoke<Void>(0x71BDB63DBAF8DA59, hole); } // 0x71BDB63DBAF8DA59 0x5133A750
	...
	static BOOL _0x0C5A80A9E096D529(Any p0, char* text, Any p2, Any p3, Any p4, Any p5) { return invoke<BOOL>(0x0C5A80A9E096D529, p0, text, p2, p3, p4, p5); } // 0x0C5A80A9E096D529
	...
	static void _0x77F16B447824DA6C(int p0) { invoke<Void>(0x77F16B447824DA6C, p0); } // 0x77F16B447824DA6C 0x0A89336C
	static void _0xCDCA26E80FAECB8F() { invoke<Void>(0xCDCA26E80FAECB8F); } // 0xCDCA26E80FAECB8F 0xC84BE309
	static void PAUSE_MENU_ACTIVATE_CONTEXT(Hash contextHash) { invoke<Void>(0xDD564BDD0472C936, contextHash); } // 0xDD564BDD0472C936 0x9FE8FD5E
	static void OBJECT_DECAL_TOGGLE(Hash contextHash) { invoke<Void>(0x444D8CF241EC25C5, contextHash); } // 0x444D8CF241EC25C5 0x0029046E
	...
	static BOOL _0x2E22FEFA0100275E() { return invoke<BOOL>(0x2E22FEFA0100275E); } // 0x2E22FEFA0100275E 0x96863460
...
namespace GRAPHICS
{
	...
	static void DRAW_LINE(float x1, float y1, float z1, float x2, float y2, float z2, int red, int green, int blue, int alpha) { invoke<Void>(0x3615BE09BC5B981A, x1, y1, z1, x2, y2, z2, red, green, blue, alpha); } // 0x6B7256074AE34680 0xB3426BCC
	...
	static BOOL _0x4862437A486F91B0(char* p0, Any* p1, Any* p2, BOOL p3) { return invoke<BOOL>(0x4862437A486F91B0, p0, p1, p2, p3); } // 0x4862437A486F91B0 0x56C1E488
	static int _0x1670F8D05056F257(Any p0) { return invoke<int>(0x1670F8D05056F257, p0); } // 0x1670F8D05056F257 0x226B08EA
	static BOOL _0x7FA5D82B8F58EC06() { return invoke<BOOL>(0x7FA5D82B8F58EC06); } // 0x7FA5D82B8F58EC06 0x1F3CADB0
	static int _0x5B0316762AFD4A64() { return invoke<int>(0x5B0316762AFD4A64); } // 0x5B0316762AFD4A64 0xA9DC8558
	static void _0x346EF3ECAAAB149E() { invoke<Void>(0x346EF3ECAAAB149E); } // 0x346EF3ECAAAB149E 0x88EAF398
	static BOOL _0xA67C35C56EB1BD9D() { return invoke<BOOL>(0xA67C35C56EB1BD9D); } // 0xA67C35C56EB1BD9D 0x47B0C137
	static int _0x0D6CA79EEEBD8CA3() { return invoke<int>(0x0D6CA79EEEBD8CA3); } // 0x0D6CA79EEEBD8CA3 0x65376C9B
	...
	static BOOL _0x3DEC726C25A11BAC(int p0) { return invoke<BOOL>(0x3DEC726C25A11BAC, p0); } // 0x3DEC726C25A11BAC 0x3B15D33C
	static void _POP_SCALEFORM_MOVIE_FUNCTION_VOID() { invoke<Void>(0xC6796A8FFA375E53); } // 0xC6796A8FFA375E53 0x02DBF2D
	static int _0x0C0C4E81E1AC60A0() { return invoke<int>(0x0C0C4E81E1AC60A0); } // 0x0C0C4E81E1AC60A0 0xEC5D0317
	static BOOL _0x759650634F07B6B4(int p0) { return invoke<BOOL>(0x759650634F07B6B4, p0); } // 0x759650634F07B6B4 0x25D569EB
	static int _0xCB82A0BF0E3E3265(int p0) { return invoke<int>(0xCB82A0BF0E3E3265, p0); } // 0xCB82A0BF0E3E3265 0xCFCDC518
	...
	static BOOL _0x2A893980E96B659A(BOOL p0) { return invoke<BOOL>(0x2A893980E96B659A, p0); } // 0x2A893980E96B659A 0x199FABF0
	static int _0xF5BED327CEA362B1(BOOL p0) { return invoke<int>(0xF5BED327CEA362B1, p0); } // 0xF5BED327CEA362B1 0x596B900D
	...
	static void _SET_CHECKPOINT_ICON_HEIGHT(int checkpoint, float iconHeight) { invoke<Void>(0x4B5B4DA5D79F1943, checkpoint, iconHeight); } // 0x4B5B4DA5D79F1943 0x80151CCF
	...
	static void REQUEST_STREAMED_TEXTURE_DICT(char* textureDict, BOOL unused) { invoke<Void>(0xDFA2EF8E04127DD5, textureDict, unused); } // 0xDFA2EF8E04127DD5 0x4C9B035F
	...
	static void SET_SCRIPT_GFX_DRAW_BEHIND_PAUSEMENU(BOOL p0) { invoke<Void>(0xC6372ECD45D73BCD, p0); } // 0xC6372ECD45D73BCD 0xF8FBCC25
	static void _SET_UI_LAYER(int layer) { invoke<Void>(0x61BB1D9B3A95D802, layer); } // 0x61BB1D9B3A95D802 0xADF81D24
	static void SET_SCRIPT_GFX_ALIGN(int x, int y) { invoke<Void>(0xB8A850F20A067EB6, x, y); } // 0xB8A850F20A067EB6 0x228A2598
	static void RESET_SCRIPT_GFX_ALIGN() { invoke<Void>(0xE3A3DB414A373DAB); } // 0xE3A3DB414A373DAB 0x3FE33BD6
	...
	static void _0x6DD8F5AA635EB4B2(float p0, float p1, float* p2, float* p3) { invoke<Void>(0x6DD8F5AA635EB4B2, p0, p1, p2, p3); } // 0x6DD8F5AA635EB4B2
	...
	static void SET_ARTIFICIAL_LIGHTS_STATE(BOOL state) { invoke<Void>(0x1268615ACE24D504, state); } // 0x1268615ACE24D504 0xAA2A0EAF
	static void _0xC35A6D07C93802B2() { invoke<Void>(0xC35A6D07C93802B2); } // 0xC35A6D07C93802B2
	static int CREATE_TRACKED_POINT() { return invoke<int>(0xE2C9439ED45DEA60); } // 0xE2C9439ED45DEA60 0x3129C31A
	static void SET_TRACKED_POINT_INFO(int point, float x, float y, float z, float radius) { invoke<Void>(0x164ECBB3CF750CB0, point, x, y, z, radius); } // 0x164ECBB3CF750CB0 0x28689AA4
	static BOOL IS_TRACKED_POINT_VISIBLE(int point) { return invoke<BOOL>(0xC45CCDAAC9221CA8, point); } // 0xC45CCDAAC9221CA8 0x0BFC4F64
	static void DESTROY_TRACKED_POINT(int point) { invoke<Void>(0xB25DC90BAD56CA42, point); } // 0xB25DC90BAD56CA42 0x14AC675F
	...
	static void _0x6D955F6A9E0295B1(float x, float y, float z, float p3, float p4, float p5, float p6) { invoke<Void>(0x6D955F6A9E0295B1, x, y, z, p3, p4, p5, p6); } // 0x6D955F6A9E0295B1
	...
	static void _0xD2936CAB8B58FCBD(int p0, BOOL p1, float x, float y, float z, float p5, BOOL p6, BOOL p7) { invoke<Void>(0xD2936CAB8B58FCBD, p0, p1, x, y, z, p5, p6, p7); } // 0xD2936CAB8B58FCBD
	...
	static void _TOGGLE_PAUSE_RENDER_PHASES(BOOL toggle) { invoke<Void>(0xDFC252D8A3E15AB7, toggle); } // 0xDFC252D8A3E15AB7 0x30ADE541
	...
	static BOOL START_NETWORKED_PARTICLE_FX_NON_LOOPED_AT_COORD(char* effectName, float xPos, float yPos, float zPos, float xRot, float yRot, float zRot, float scale, BOOL xAxis, BOOL yAxis, BOOL zAxis) { return invoke<BOOL>(0xF56B8137DF10135D, effectName, xPos, yPos, zPos, xRot, yRot, zRot, scale, xAxis, yAxis, zAxis); } // 0xF56B8137DF10135D 0x633F8C48
	...
	static void SET_PARTICLE_FX_LOOPED_FAR_CLIP_DIST(int ptfxHandle, float dist) { invoke<Void>(0xDCB194B85EF7B541, ptfxHandle, dist); } // 0xDCB194B85EF7B541 0x233DE879
	...
	static void USE_PARTICLE_FX_ASSET(char* name) { invoke<Void>(0x6C38AF3693A69A91, name); } // 0x6C38AF3693A69A91 0x9C720B61
	...
	static void _OVERRIDE_DECAL_TEXTURE(int decalType, char* textureDict, char* textureName) { invoke<Void>(0x8A35C742130C6080, decalType, textureDict, textureName); } // 0x8A35C742130C6080 0x335695CF
	static void _0xB7ED70C49521A61D(int decalType) { invoke<Void>(0xB7ED70C49521A61D, decalType); } // 0xB7ED70C49521A61D 0x7B786555
	static void MOVE_VEHICLE_DECALS(Vehicle vehicle1, Vehicle vehicle2) { invoke<Void>(0x84C8D7C2D30D3280, vehicle1, vehicle2); } // 0x84C8D7C2D30D3280 0xCE9E6CF2
	...
	static BOOL _DOES_VEHICLE_HAVE_DECAL(Vehicle vehicle, int decalIndex) { return invoke<BOOL>(0x060D935D3981A275, vehicle, decalIndex); } // 0x060D935D3981A275 0x6D58F73B
	...
	static void _PRESET_INTERIOR_AMBIENT_CACHE(char* tcModifierName) { invoke<Void>(0xD7021272EB0A451E, tcModifierName); } // 0xD7021272EB0A451E
	...
	static void _0x5096FD9CCB49056D(char* p0) { invoke<Void>(0x5096FD9CCB49056D, p0); } // 0x5096FD9CCB49056D 0x908A335E
	...
	static void _ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_STRING(const char* value) { invoke<Void>(0xBA7148484BD90365, value); } // 0xBA7148484BD90365 0x4DAAD55B
	...
	static void SET_TV_CHANNEL_PLAYLIST(int channel, char* playlist, BOOL fromBeginning) { invoke<Void>(0xF7B38B8305F1FE8B, channel, playlist, fromBeginning); } // 0xF7B38B8305F1FE8B 0xB262DE67
	...
	static BOOL _IS_TV_PLAYLIST_ITEM_PLAYING(Hash videoClip) { return invoke<BOOL>(0x0AD973CA1E077B60, videoClip); } // 0x0AD973CA1E077B60 0x4D1EB0FB
	...
	static void ANIMPOSTFX_PLAY(char* effectName, int duration, BOOL looped) { invoke<Void>(0x2206BF9A37B7F724, effectName, duration, looped); } // 0x2206BF9A37B7F724 0x1D980479
	static void ANIMPOSTFX_STOP(char* effectName) { invoke<Void>(0x068E835A1D0DC0E3, effectName); } // 0x068E835A1D0DC0E3 0x06BB5CDA
	static BOOL ANIMPOSTFX_IS_RUNNING(char* effectName) { return invoke<BOOL>(0x36AD3E690DA5ACEB, effectName); } // 0x36AD3E690DA5ACEB 0x089D5921
	static void ANIMPOSTFX_STOP_ALL() { invoke<Void>(0xB4EDDC19532BFB85); } // 0xB4EDDC19532BFB85 0x4E6D875B
...
namespace STATS
{
	...
	static BOOL STAT_GET_POS(Hash statHash, float* x, float* y, float* z, int p4) { return invoke<BOOL>(0x350F82CCB186AA1B, statHash, x, y, z, p4); } // 0x350F82CCB186AA1B 0xC846ECCE
	static BOOL STAT_GET_MASKED_INT(Hash statHash, int* outValue, Any p2, Any p3, Any p4) { return invoke<BOOL>(0x655185A06D9EEAAB, statHash, outValue, p2, p3, p4); } // 0x655185A06D9EEAAB 0xE9D9B70F
	...
	static void STAT_SET_PROFILE_SETTING_VALUE(int profileSetting, int value) { invoke<Void>(0x68F01422BE1D838F, profileSetting, value); } // 0x68F01422BE1D838F 0x24DD4929
	...
	static void PLAYSTATS_RANK_UP(Player player) { invoke<Void>(0xC7F2DE41D102BFB4, player); } // 0xC7F2DE41D102BFB4 0x56AFB9F5
	...
	static void PLAYSTATS_RANDOM_MISSION_DONE(char* name, Any p1, Any p2, Any p3) { invoke<Void>(0x71862B1D855F32E1, name, p1, p2, p3); } // 0x71862B1D855F32E1 0xAC2C7C63
	static void PLAYSTATS_ROS_BET(int amount, int act, Player player, float cm) { invoke<Void>(0x121FB4DDDC2D5291, amount, act, player, cm); } // 0x121FB4DDDC2D5291 0x413539BC
	...
	static void PLAYSTATS_ACQUIRED_HIDDEN_PACKAGE(Any p0) { invoke<Void>(0x79AB33F0FBFAC40C, p0); } // 0x79AB33F0FBFAC40C 0x8D5C7B37
	...
	static void PLAYSTATS_QUICKFIX_TOOL(int element, char* item) { invoke<Void>(0x90D0622866E80445, element, item); } // 0x90D0622866E80445 0x66FEB701
	...
	static BOOL _LEADERBOARDS2_WRITE_DATA_EX(Any* p0, Any* p1) { return invoke<BOOL>(0xC980E62E33DF1D5C, p0, p1); } // 0xC980E62E33DF1D5C 0x62C19A3D
...
namespace MOBILE
{
	static void CREATE_MOBILE_PHONE(int p4) { invoke<Void>(0xA4E8E696C532FBC7, p4); } // 0xA4E8E696C532FBC7 0x5BBC5E23
...
namespace APP
{
	static Hash APP_DATA_VALID() { return invoke<Hash>(0x846AA8E7D55EE5B6); } // 0x846AA8E7D55EE5B6 0x72BDE002
...
namespace PATHFIND
{
	...
	static BOOL GET_CLOSEST_MAJOR_VEHICLE_NODE(float x, float y, float z, Vector3* outPosition, float p5, int p6) { return invoke<BOOL>(0x2EABE3B06F58C1BE, x, y, z, outPosition, p5, p6); } // 0x2EABE3B06F58C1BE 0x04B5F15B
	...
	static BOOL GET_NTH_CLOSEST_VEHICLE_NODE(float x, float y, float z, int nthClosest, Vector3* outPosition, BOOL p6, float p7, float p8) { return invoke<BOOL>(0xE50E52416CCF948B, x, y, z, nthClosest, outPosition, p6, p7, p8); } // 0xE50E52416CCF948B 0xF125BFCC
	...
	static BOOL GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(float x, float y, float z, int nthClosest, Vector3* outPosition, float* outHeading, int* outInt, int p6, float p7, float p8) { return invoke<BOOL>(0x80CA6A8B6C094CC4, x, y, z, nthClosest, outPosition, outHeading, outInt, p6, p7, p8); } // 0x80CA6A8B6C094CC4 0x7349C856
	static Any GET_NTH_CLOSEST_VEHICLE_NODE_ID_WITH_HEADING(float x, float y, float z, int nthClosest, Vector3* outPosition, float* outHeading, int nodeType, float p7, float p8) { return invoke<Any>(0x6448050E9C2A7207, x, y, z, nthClosest, outPosition, outHeading, nodeType, p7, p8); } // 0x6448050E9C2A7207 0xC1AEB88D
	...
	static Any GET_CLOSEST_ROAD(float posX, float posY, float posZ, float p3, int p4, NativeVector3* p5, NativeVector3* p6, int* p7, int* p8, float* p9, int p10) { return invoke<Any>(0x132F52BBA570FE92, posX, posY, posZ, p3, p4, p5, p6, p7, p8, p9, p10); } // 0x132F52BBA570FE92 0x567B0E11
	...
	static int GENERATE_DIRECTIONS_TO_COORD(float x, float y, float z, BOOL p3, float* direction, float* vehicle, float* distToNxJunction) { return invoke<int>(0xF90125F1F79ECDF8, x, y, z, p3, direction, vehicle, distToNxJunction); } // 0xF90125F1F79ECDF8 0xED35C094
	...
	static void DISABLE_NAVMESH_IN_AREA(float x1, float y1, float z1, float x2, float y2, float z2, BOOL disable) { invoke<Void>(0x4C8872D8CDBE1B8B, x1, y1, z1, x2, y2, z2, disable); } // 0x4C8872D8CDBE1B8B 0x6E37F132
...
namespace CONTROLS
{
	...
	static BOOL IS_CONTROL_PRESSED(int inputGroup, int contorl) { return invoke<BOOL>(0xF3A21BCD95725A4A, inputGroup, contorl); } // 0xF3A21BCD95725A4A 0x517A4384
	...
	static char* GET_CONTROL_INSTRUCTIONAL_BUTTON(int inputGroup, int control, Player p2) { return invoke<char*>(0x0499D7B09FC9B407, inputGroup, control, p2); } // 0x0499D7B09FC9B407 0x3551727A
...
namespace DATAFILE
{
	...
	static Any* _OBJECT_VALUE_GET_OBJECT(Any* sCloudFile, char* key) { return invoke<Any*>(0xB6B9DDC412FCEEE2, sCloudFile, key); } // 0xB6B9DDC412FCEEE2 0xC9C13D8D
...
namespace FIRE
{
	static Hash START_SCRIPT_FIRE(float X, float Y, float Z, int maxChildren, BOOL isGasFire) { return invoke<Hash>(0x6B83617E04503888, X, Y, Z, maxChildren, isGasFire); } // 0x6B83617E04503888 0xE7529357
	static void REMOVE_SCRIPT_FIRE(int fireHandle) { invoke<Void>(0x7FF548385680673F, fireHandle); } // 0x7FF548385680673F 0x6B21FE26
	static Ped START_ENTITY_FIRE(Ped entity) { return invoke<Ped>(0xF6A9D9708F6F23DF, entity); } // 0xF6A9D9708F6F23DF 0x8928428E
	...
	static int _0x6070104B699B2EF4(int explosionType, float x1, float y1, float z1, float x2, float y2, float z2) { return invoke<int>(0x6070104B699B2EF4, explosionType, x1, y1, z1, x2, y2, z2); } // 0x6070104B699B2EF4
...
namespace ROPE
{
	...
	static void _0xDC57A637A20006ED(Object rope, int unk) { invoke<Void>(0xDC57A637A20006ED, rope, unk); } // 0xDC57A637A20006ED 0x80DB77A7
	static void _0x36CCB9BE67B970FD(Object rope, BOOL p1) { invoke<Void>(0x36CCB9BE67B970FD, rope, p1); } // 0x36CCB9BE67B970FD 0xC67D5CF6
	static BOOL _0x84DE3B5FB3E666F0(Object rope) { return invoke<BOOL>(0x84DE3B5FB3E666F0, rope); } // 0x84DE3B5FB3E666F0 0x7A18BB9C
	...
	static void ROPE_LOAD_Lifix() { invoke<Void>(0x9B9039DBF2D258C1); } // 0x9B9039DBF2D258C1 0xBA97CE91
	static BOOL ROPE_ARE_Lifix_LOADED() { return invoke<BOOL>(0xF2D0E6A75CC05597); } // 0xF2D0E6A75CC05597 0x5FDC1047
	static void ROPE_UNLOAD_Lifix() { invoke<Void>(0x6CE36C35C1AC8163); } // 0x6CE36C35C1AC8163 0x584463E0
	...
	static void BREAK_ENTITY_GLASS(Object object, float posX, float posY, float posZ, float p4, float offsetX, float offsetY, float offsetZ, float p8, int p9, BOOL p10) { invoke<Void>(0x2E648D16F6E308F3, object, posX, posY, posZ, p4, offsetX, offsetY, offsetZ, p8, p9, p10); } // 0x2E648D16F6E308F3 0xD0E0402F
	...
	static void _0xCC6E963682533882(Object object) { invoke<Void>(0xCC6E963682533882, object); } // 0xCC6E963682533882
...
namespace WATER
{
	static BOOL GET_WATER_HEIGHT(float x, float y, float A, float* height) { return invoke<BOOL>(0xF6829842C06AE524, x, y, A, height); } // 0xF6829842C06AE524 0xD864E17C
	static BOOL GET_WATER_HEIGHT_NO_WAVES(float B, float y, float z, float* height) { return invoke<BOOL>(0x8EE6B53CE13A9794, B, y, z, height); } // 0x8EE6B53CE13A9794 0x262017F8
	...
	static BOOL TEST_PROBE_AGAINST_ALL_WATER(float x1, float y1, float z1, float x2, float y2, float z2, int type, float unkVector) { return invoke<BOOL>(0x8974647ED222EA5F, x1, y1, z1, x2, y2, z2, type, unkVector); } // 0x8974647ED222EA5F 0x4A962D55
	static BOOL TEST_VERTICAL_PROBE_AGAINST_ALL_WATER(float x, float y, float z, float p3, float* height) { return invoke<BOOL>(0x2B3451FA1E3142E2, x, y, z, p3, height); } // 0x2B3451FA1E3142E2 0x4C71D143
	...
	static void _REMOVE_CURRENT_RISE(int riseHandle) { invoke<Void>(0xB1252E3E59A82AAF, riseHandle); } // 0xB1252E3E59A82AAF
...
{
	static int START_SHAPE_TEST_LOS_PROBE(float x1, float y1, float z1, float x2, float y2, float z2, int flags, Entity ent, int p8) { return invoke<int>(0x7EE9F5D83DD4F90E, x1, y1, z1, x2, y2, z2, flags, ent, p8); } // 0x7EE9F5D83DD4F90E 0xEFAF4BA6
	...
	static void _SHAPE_TEST_RESULT_ENTITY(Hash entityHit) { invoke<Void>(0x2B3334BCA57CD799, entityHit); } // 0x2B3334BCA57CD799 0xEC2AAF06
}
...
namespace NETWORK
{
	...
	static BOOL _0xEBCAB9E5048434F4() { return invoke<BOOL>(0xEBCAB9E5048434F4); } // 0xEBCAB9E5048434F4
	static BOOL _0x74FB3E29E6D10FA9() { return invoke<BOOL>(0x74FB3E29E6D10FA9); } // 0x74FB3E29E6D10FA9
	...
	static BOOL _NETWORK_HAS_RESTRICTED_PROFILE() { return invoke<BOOL>(0x1353F87E89946207); } // 0x1353F87E89946207
	...
	static BOOL NETWORK_IS_MULTIPLAYER_DISABLED() { return invoke<BOOL>(0x9747292807126EDA); } // 0x9747292807126EDA 0x05518C0F
	...
	static void _NETWORK_SCTV_SLOTS(int p0) { invoke<Void>(0x49EC8030F5015F8B, p0); } // 0x49EC8030F5015F8B 0x3C3E2AB6
	...
	static BOOL NETWORK_FIND_MATCHED_GAMERS(int unk, float p1, float neg1a, float neg1b) { return invoke<BOOL>(0xF7B2CFDE5C9F700D, unk, p1, neg1a, neg1b); } // 0xF7B2CFDE5C9F700D 0xA13045D4
	static BOOL NETWORK_IS_FINDING_GAMERS() { return invoke<BOOL>(0xDDDF64C91BFCF0AA); } // 0xDDDF64C91BFCF0AA 0xA6DAA79F
	static BOOL _0xF9B83B77929D8863() { return invoke<BOOL>(0xF9B83B77929D8863); } // 0xF9B83B77929D8863 0xBEDC4503
	...
	static void _SERVER_HANDLER() { invoke<Void>(0xF814FEC6A19FD6E0); } // 0xF814FEC6A19FD6E0 0x32B7A076
	...
	static BOOL NETWORK_SESSION_IS_VISIBLE() { return invoke<BOOL>(0xBA416D68C631496A); } // 0xBA416D68C631496A 0x4977AC28
	static void NETWORK_SESSION_BLOCK_JOIN_REQUESTS(BOOL toggle) { invoke<Void>(0xA73667484D7037C3, toggle); } // 0xA73667484D7037C3 0xE6EEF8AF
	...
	static void NETWORK_SESSION_VOICE_CONNECT_TO_PLAYER(Any* p0) { invoke<Void>(0xABD5E88B8A2D3DB2, p0); } // 0xABD5E88B8A2D3DB2 0x9DFD89E6
	...
	static BOOL NETWORK_IS_ACTIVITY_SPECTATOR() { return invoke<BOOL>(0x12103B9E0C9F92FB); } // 0x12103B9E0C9F92FB 0xAF329720
	...
	static Any NETWORK_HOST_TRANSITION(Any p0, int playerCount, Any p2, Hash jobHash, Any p4, Any p5) { return invoke<Any>(0xA60BB5CE242BB254, p0, playerCount, p2, jobHash, p4, p5); } // 0xA60BB5CE242BB254 0x146764FB
	...
	static BOOL NETWORK_DO_TRANSITION_TO_NEW_FREEMODE(int* networkHandle, Any* p1, int players, BOOL p3, BOOL p4, BOOL p5) { return invoke<BOOL>(0x9E80A5BA8109F974, networkHandle, p1, players, p3, p4, p5); } // 0x9E80A5BA8109F974 0xAD13375E
	...
	static Any _0x44B37CDCAE765AAE(Player p0, BOOL* p1) { return invoke<Any>(0x44B37CDCAE765AAE, p0, p1); } // 0x44B37CDCAE765AAE
	...
	static BOOL _NETWORK_PLAYER_IS_UNK() { return invoke<BOOL>(0x172F75B6EE2233BA); } // 0x172F75B6EE2233BA 0x1720ABA6
	static BOOL NETWORK_PLAYER_IS_BADSPORT() { return invoke<BOOL>(0x19D8DA0E5A68045A); } // 0x19D8DA0E5A68045A 0xA19708E3
	static Blip* _TACO_NIGGER(Pickup* enough, float* _007, Vehicle isgay) { return invoke<Blip*>(0x46FB3ED415C7641C, enough, _007, isgay); } // 0x46FB3ED415C7641C 0xF9A51B92
	static BOOL BAD_SPORT_PLAYER_LEFT_DETECTED(int* networkHandle, int p1, int p2) { return invoke<BOOL>(0xEC5E3AF5289DCA81, networkHandle, p1, p2); } // 0xEC5E3AF5289DCA81 0x4C2C6B6A
	...
	static void NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(int* vars, int sizeofVars) { invoke<Void>(0x3E9B2F01C50DF595, vars, sizeofVars); } // 0x3E9B2F01C50DF595 0xDAF3B0AE
	static void NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(char* vars, ScrHandle numVars) { invoke<Void>(0x3364AA97340CA215, vars, numVars); } // 0x3364AA97340CA215 0xBE3D32B4
	...
	static BOOL NETWORK_IS_PLAYER_A_PARTICIPANT(Player playerId) { return invoke<BOOL>(0x3CA58F6CB7CBD784, playerId); } // 0x3CA58F6CB7CBD784 0xB08B6992
	...
	static int _NETWORK_GET_PLAYER_PED_FROM_INDEX() { return invoke<int>(0x638A3A81733086DB); } // 0x638A3A81733086DB 0xDB8B5D71
	...
	static BOOL NETWORK_DOES_ENTITY_EXIST_WITH_NETWORK_ID(int netId) { return invoke<BOOL>(0x18A47D074708FD68, netId); } // 0x18A47D074708FD68 0x1E2E3177
	...
	static char* NETWORK_PLAYER_GET_USERID(Player player, char* userID) { return invoke<char*>(0x4927FC39CD0869A0, player, userID); } // 0x4927FC39CD0869A0 0x4EC0D983
	...
	static BOOL _NETWORK_PLAYER_IS_CHEATER(Player player) { return invoke<BOOL>(0x565E430DB3B05BEC, player); } // 0x565E430DB3B05BEC 0xD265B049
	...
	static BOOL NETWORK_IS_PENDING_FRIEND(Any p0) { return invoke<BOOL>(0x0BE73DA6984A6E33, p0); } // 0x0BE73DA6984A6E33 0x5C85FF81
	static BOOL NETWORK_IS_ADDING_FRIEND() { return invoke<BOOL>(0x6EA101606F6E4D81); } // 0x6EA101606F6E4D81 0xBB7EC8C4
	...
	static void _NETWORK_RESPAWN_PLAYER(Player player, BOOL p1) { invoke<Void>(0xBF22E0F32968E967, player, p1); } // 0xBF22E0F32968E967 0x22E03AD0
	...
	static BOOL _NETWORK_GET_PLAYER_CREW_EMBLEM_TXD_NAME(Player* player, Any* p1) { return invoke<BOOL>(0x5835D9CD92E83184, player, p1); } // 0x5835D9CD92E83184 0xBA672146
	...
	static void NETWORK_SET_IN_SPECTATOR_MODE_EXTENDED(BOOL toggle, Ped playerPed, BOOL p2) { invoke<Void>(0x419594E137637120, toggle, playerPed, p2); } // 0x419594E137637120 0x54058F5F
	...
	static BOOL NETWORK_IS_IN_TUTORIAL_SESSION() { return invoke<BOOL>(0xADA24309FE08DACF); } // 0xADA24309FE08DACF 0x34DD7B28
	...
	static BOOL _NETWORK_HAVE_TUNABLES_BEEN_DOWNLOADED() { return invoke<BOOL>(0x0467C11ED88B7D28); } // 0x0467C11ED88B7D28
	...
	static Any NETWORK_EXPLODE_VEHICLE(Vehicle vehicle, BOOL isAudible, BOOL isInvisible, Player player) { return invoke<Any>(0x301A42153C9AD707, vehicle, isAudible, isInvisible, player); } // 0x301A42153C9AD707 0x0E1B38AE
	...
	static void _NETWORK_CACHE_LOCAL_PLAYER_HEAD_BLEND_DATA() { invoke<Void>(0xBD0BE0BFC927EAC1); } // 0xBD0BE0BFC927EAC1
	...
	static Hash _0x3A3D5568AF297CD5(Hash p1) { return invoke<Hash>(0x3A3D5568AF297CD5, p1); } // 0x3A3D5568AF297CD5 0x9B9AFFF1
	static void CLOUD_CHECK_AVAILABILITY() { invoke<Void>(0x4F18196C8D38768D); } // 0x4F18196C8D38768D 0xC38E9DB0
	...
	static char* GET_PLAYER_ADVANCED_MODIFIER_PRIVILEGES(int p0) { return invoke<char*>(0xCD67AD041A394C9C, p0); } // 0xCD67AD041A394C9C 0x8F3137E6
	...
	static Any _0xBAF6BABF9E7CCC13(int p0, Any* p1) { return invoke<Any>(0xBAF6BABF9E7CCC13, p0, p1); } // 0xBAF6BABF9E7CCC13 0x744A9EA5
	...
	static BOOL _0x66B59CFFD78467AF() { return invoke<BOOL>(0x66B59CFFD78467AF); } // 0x66B59CFFD78467AF 0x0CA1167F
	static BOOL _0x606E4D3E3CCCF3EB() { return invoke<BOOL>(0x606E4D3E3CCCF3EB); } // 0x606E4D3E3CCCF3EB 0x424C6E27
	...
	static BOOL _0x422D396F80A96547() { return invoke<BOOL>(0x422D396F80A96547); } // 0x422D396F80A96547 0xC6EA802E
	static BOOL NETWORK_HAS_ROS_PRIVILEGE(int index) { return invoke<BOOL>(0xA699957E60D80214, index); } // 0xA699957E60D80214 0xFD261E30
	static BOOL _0xC22912B1D85F26B1(int p0, int* p1, Any* p2) { return invoke<BOOL>(0xC22912B1D85F26B1, p0, p1, p2); } // 0xC22912B1D85F26B1 0x8570DD34
	static BOOL _0x593570C289A77688() { return invoke<BOOL>(0x593570C289A77688); } // 0x593570C289A77688
	...
	static void _NETWORK_UPDATE_PLAYER_SCARS() { invoke<Void>(0xB7C7F6AD6424304B); } // 0xB7C7F6AD6424304B 0x371BBA08
...
{
	static void NETWORK_INITIALIZE_CASH(int p1, int p2) { invoke<Void>(0x3DA5ECD1A56CBA6D, p1, p2); } // 0x3DA5ECD1A56CBA6D 0x66DA9935
	...
	static BOOL NETWORK_CAN_SHARE_JOB_CASH() { return invoke<BOOL>(0x1C2473301B1C66BA); } // 0x1C2473301B1C66BA 0xA27B9FE8
	...
	static void _NETWORK_EARN_FROM_BEND_JOB(int amount, char* heistHash) { invoke<Void>(0x61326EE6DF15B0CA, amount, heistHash); } // 0x61326EE6DF15B0CA 0x5E81F55C
	...
	static BOOL _0x6FCF8DDEA146C45B(int p0) { return invoke<BOOL>(0x6FCF8DDEA146C45B, p0); } // 0x6FCF8DDEA146C45B 0xB96C7ABE
}
...
namespace DLC1
{
	...
	static BOOL _0xFF56381874F82086(int character, int p1, int* outComponent) { return invoke<BOOL>(0xFF56381874F82086, character, p1, outComponent); } // 0xFF56381874F82086 0x2E9D628C
...
namespace DLC2
{
	...
	static void _UNLOAD_MP_DLC_MAPS() { invoke<Void>(0xD7C10C4A637992C9); } // 0xD7C10C4A637992C9
...
namespace SOCIALCLUB
{
	...
	static BOOL _0xBC1CC91205EC8D6E() { return invoke<BOOL>(0xBC1CC91205EC8D6E); } // 0xBC1CC91205EC8D6E 0x6C5738AB
	static char* _0xDF649C4E9AFDD788() { return invoke<char*>(0xDF649C4E9AFDD788); } // 0xDF649C4E9AFDD788 0x468668F0
...
namespace UNK3
{
	static int _NETWORK_SHOP_GET_PRICE(Hash itemHash, Hash categoryHash, int unused) { return invoke<int>(0xC27009422FCCA88D, itemHash, categoryHash, unused); } // 0xC27009422FCCA88D
	...
	static BOOL _NETWORK_SHOP_BEGIN_SERVICE(Any* transactionID, Hash p1, Hash transactionHash, Any amount, Hash p4, Any mode) { return invoke<BOOL>(0x3C5FD37B5499582E, transactionID, p1, transactionHash, amount, p4, mode); } // 0x3C5FD37B5499582E
...
namespace TEST
{
	static void _SET_INTERIOR_COATING_COLOR(Vehicle vehicle, int id) { invoke<Void>(0xF40DD601A65F7F19, vehicle, id); }
	static void _SET_INTERIOR_DASH_LIGHT_COLOR(Vehicle vehicle, int id) { invoke<Void>(0x6089CDF6A57F326C, vehicle, id); }
}
