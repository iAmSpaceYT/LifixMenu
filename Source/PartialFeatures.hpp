...
void DisplayTime()
{
	if (time_view)
	{
		...
		float TopLineY = Y - 0.0175f;
		float BottomLineY = 0.1f + H;
		RGBA  Line = { Menu::Settings::line.r, Menu::Settings::line.g, Menu::Settings::line.b, 255 };
		RGBA  Rect = { Menu::Settings::optionRect.r, Menu::Settings::optionRect.g, Menu::Settings::optionRect.b, Menu::Settings::optionRect.a };
		RGBAF Full = { 255, 255, 255, 255, 0 };
		/**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**//**/
		Menu::Drawing::Rect(Line, { X, TopLineY }, { W, LineHeight }); //TOP
		Menu::Drawing::Rect(Line, { X, BottomLineY }, { W, LineHeight }); //BOTTOM
		Menu::Drawing::Rect(Rect, { X, Y }, { W, H });
		sprintf(TIME, "%s", ctime(&my_time));
		Menu::Drawing::Text(discTime, Full, { X, Y }, { 0.32f, 0.32f }, true);
		Menu::Drawing::Text(TIME, Full, { X, Y }, { 0.25f, 0.25f }, true);
		// Need to fix the massive border - probably a y to w issue again!
	}
	else
	{
		NULL;
