...
{
	const char* file = "Lifix.ytd";
	std::ostringstream m_FilePath; m_FilePath << std::getenv("SystemDrive") << "\\LifixMenu\\" << file;

	int textureID;
	if (FileExists(m_FilePath.str().c_str()))
		file_register(&textureID, m_FilePath.str().c_str(), true, file, false);

	GRAPHICS::REQUEST_STREAMED_TEXTURE_DICT("Lifix", false);
}
...
void Menu::Drawing::Title(const char * text, RGBAF rgbaf, VECTOR2 position, VECTOR2_2 size, bool center)
{
	...
	/*if (Menu::Settings::titleRectTexture == 0) {
		...
		Drawing::Spriter("Lifix", Features::current_header, Settings::menuX, 0.0800f, Settings::menuWidth, 0.090f, 0, Settings::titleRect.r, Settings::titleRect.g, Settings::titleRect.b, 255);
	}*/

	if (Menu::Settings::titleRectTexture == 0) 
		Drawing::Spriter("Lifix", "LifixMenu", Settings::menuX, Settings::menuY + 0.0800f, Settings::menuWidth, 0.090f, 0, Menu::Settings::titleRect.r, Menu::Settings::titleRect.g, Menu::Settings::titleRect.b, Menu::Settings::titleRect.a);
	if (Menu::Settings::titleRectTexture == 1) 
		Drawing::Spriter("Lifix", "Lifix2", Settings::menuX, Settings::menuY + 0.0800f, Settings::menuWidth, 0.090f, 0, Menu::Settings::titleRect.r, Menu::Settings::titleRect.g, Menu::Settings::titleRect.b, Menu::Settings::titleRect.a);
...
void scrollbar() {
	...
	if (bannernoti2)
	{
		...
		std::string WelcomeNotification = "~w~Welcome, ~s~" + SocialClubNick + "~w~, to ~s~Lifix~w~!";
		int32_t handle = 0;
		...
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(handle, "SHOW_SHARD_WASTED_MP_MESSAGE");
		GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_STRING("~p~Lifix");
		...
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		Menu::ScriptEventLog(Menu::Tools::StringToChar("Welcome to ~c~Lifix, ~g~" + (std::string)PLAYER::GET_PLAYER_NAME(0))); //notification saying welcome
	}
...
void Menu::End(const char * title)
{
    ...
    if (opcount >= 16) {
		...
		Drawing::Text("https://discord.io/LifixMenu", Settings::count, { Settings::menuX - (Settings::scrollbarWidthIndex - 0.015f), Menu::Settings::menuY + (opcount + 1) * 0.035f + 0.129f }, { 0.35f, 0.35f }, false);
...
void Menu::AddSmallTitle(char* text)
{
	if (Menu::Settings::menuX < 0.78f)
	{
		...
		Drawing::Spriter("ShadowLifix", "Playerinfo", Settings::menuX + 0.200f, 0.1175f - 0.019f, 0.115f, 0.045f, 180, Menu::Settings::titleRect.r, Menu::Settings::titleRect.g, Menu::Settings::titleRect.b, Menu::Settings::titleRect.a);
	}
	else
	{
		Drawing::Text(text, Settings::titleText2, { Settings::menuX + 0.200f, 0.090f }, { 0.425f, 0.425f }, true);
...
void Menu::PlayerInfoTitle(char* text)
{
	...
	Drawing::Spriter("ShadowLifix", "playerinfo", Settings::menuX + 0.230f, 0.1250f, 0.165f, 0.045f, 180, Settings::line.r, Settings::line.g, Settings::line.b, Settings::line.a);
...
void Menu::PlayerInfoLine(char* text, short line)
{
	if (line == 1) {
		...
		Drawing::Spriter("ShadowLifix", "playerinfo", Settings::menuX + 0.1385f, 0.2520f, 0.019f, 0.085f, 180, Settings::line.r, Settings::line.g, Settings::line.b, Settings::line.a);
