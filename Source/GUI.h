...
namespace Menu {
	...
	namespace Drawing {//NiggasInMyButthole
		void YTD();
		void Text(const char* text, RGBAF rgbaf, VECTOR2 position, VECTOR2_2 size, bool center);
		void Text(const char* text, RGBAF rgbaf, VECTOR2 position, VECTOR2_2 size, bool center, bool rightAlign, bool outline);
	...
	namespace Settings {
		...
		extern RGBAF subtitleText;
		extern RGBAF NumberOption;
		extern RGBAF optionTextt;
		extern RGBA selectedText;
		extern RGBAF Spawnerrect;
		extern RGBAF Spawnerrect2;
		extern RGBAF arrow;
		extern RGBAF arrow2;
		extern RGBAF arrowww;
		extern RGBAF OnThisDick;
		extern RGBAF NotOnThisDick;
		extern RGBAF OnThisArrow;
		extern RGBAF NotOnThisArrow;
		extern RGBAF integre;
		extern RGBA optionRect;
		extern RGBA optionRectSmooth;
	...
	void GAYBOY(const char* infotext);
	...
	void Info(const char* InfoText, int option);
	...
	bool FontOption(const char* option, int f);
